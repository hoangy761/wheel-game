...
const LuckyWheelGame = () => {
  ...
  const spinWheelAoe = async (chainId: number) => {
        ...
        <div className="p-6">
          ...
          {result ? (
            ...
            <div className="flex flex-col items-center">
              ...
              <button
                onClick={() => spinWheelAoe(28122024)}
                disabled={spinning || loading}
                className="hidden mt-4 bg-gradient-to-r from-orange-500 to-red-600 hover:from-green-600 hover:to-emerald-700 
                           text-white px-8 py-3 rounded-lg text-lg font-semibold shadow-lg flex items-center 
                           disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
              >
                {loading ? (
